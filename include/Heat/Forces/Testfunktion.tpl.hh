...
#ifndef __Testfunktion_tpl_hh
#define __Testfunktion_tpl_hh
...
template<int dim>
class Testfunktion : public dealii::Function<dim> {
	public:
	Testfunktion (std::shared_ptr< dealii::Function<dim> > epsilon,
		   std::shared_ptr< dealii::Function<dim> > BoundaryValues);
	virtual ~Testfunktion() = default;
