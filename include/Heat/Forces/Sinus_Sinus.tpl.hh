...
#ifndef __Sinus_Sinus_tpl_hh
#define __Sinus_Sinus_tpl_hh
...
template<int dim>
class Sinus_Sinus : public dealii::Function<dim> {
	public:
	Sinus_Sinus (std::shared_ptr< dealii::Function<dim> > epsilon);
	virtual ~Sinus_Sinus() = default;
