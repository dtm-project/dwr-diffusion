/**
 * @file Tangens_hyperbolicus.tpl.hh
...
#ifndef __Tangens_hyperbolicus_tpl_hh
#define __Tangens_hyperbolicus_tpl_hh
...
template<int dim>
class Tangens_hyperbolicus : public dealii::Function<dim> {
	public:
	Tangens_hyperbolicus (std::shared_ptr< dealii::Function<dim> > epsilon,
		   std::shared_ptr< dealii::Function<dim> > BoundaryValues);
	virtual ~Tangens_hyperbolicus() = default;
