...
#ifndef __Moving_Hump_tpl_hh
#define __Moving_Hump_tpl_hh
...
template<int dim>
class Moving_Hump : public dealii::Function<dim> {
	public:
	Moving_Hump (std::shared_ptr< dealii::Function<dim> > epsilon,
		   std::shared_ptr< dealii::Function<dim> > BoundaryValues);
	virtual ~Moving_Hump() = default;
