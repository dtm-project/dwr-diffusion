/**
 * @file BoundaryValues_Hartmann.tpl.hh
...
#ifndef __BoundaryValues_Hartmann_tpl_hh
#define __BoundaryValues_Hartmann_tpl_hh
...
template<int dim>
class BoundaryValues_Hartmann : public dealii::Function<dim> {
	public:
	BoundaryValues_Hartmann (std::shared_ptr< dealii::Function<dim> > alpha);
	virtual ~BoundaryValues_Hartmann() = default;
