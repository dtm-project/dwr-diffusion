...
#ifndef __BoundaryValues_TF_tpl_hh
#define __BoundaryValues_TF_tpl_hh
...
template<int dim>
class BoundaryValues_TF : public dealii::Function<dim> {
	public:
	BoundaryValues_TF (std::shared_ptr< dealii::Function<dim> > epsilon);
	virtual ~BoundaryValues_TF() = default;
