...
/*  Copyright (C) 2012-2015 by Marius Paul Bruchhäuser , Uwe Köcher           */
/*                                                                            */
...
#ifndef __BoundaryValues_TH_tpl_hh
#define __BoundaryValues_TH_tpl_hh
...
template<int dim>
class BoundaryValues_TH : public dealii::Function<dim> {
	public:
	BoundaryValues_TH (std::shared_ptr< dealii::Function<dim> > epsilon);
	virtual ~BoundaryValues_TH() = default;
