...
#ifndef __BoundaryValues_MH_tpl_hh
#define __BoundaryValues_MH_tpl_hh
...
template<int dim>
class BoundaryValues_MH : public dealii::Function<dim> {
	public:
	BoundaryValues_MH (std::shared_ptr< dealii::Function<dim> > epsilon);
	virtual ~BoundaryValues_MH() = default;
