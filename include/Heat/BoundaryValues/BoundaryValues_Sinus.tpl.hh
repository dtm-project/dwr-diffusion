/**
 * @file BoundaryValues_Sinus.tpl.hh
...
#ifndef __BoundaryValues_Sinus_tpl_hh
#define __BoundaryValues_Sinus_tpl_hh
...
template<int dim>
class BoundaryValues_Sinus : public dealii::Function<dim> {
	public:
	BoundaryValues_Sinus (std::shared_ptr< dealii::Function<dim> > epsilon);
	virtual ~BoundaryValues_Sinus() = default;
