...
template<int dim>
class Diffusion_DWR__cGp_dG0__cGq_cG1 : public DTM::Problem {
public:
	Diffusion_DWR__cGp_dG0__cGq_cG1() = default;
	virtual ~Diffusion_DWR__cGp_dG0__cGq_cG1() = default;
...
protected:
	...
	struct {
		...
		/// error estimator
		std::shared_ptr< diffusion::dwr::cGp_dG0::cGq_cG1::ErrorEstimator<dim> > dwr;
	} error_estimator;
