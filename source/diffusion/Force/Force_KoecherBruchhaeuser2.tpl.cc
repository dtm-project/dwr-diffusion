/**
 * @file Force_KoecherBruchhaeuser2.tpl.cc
...
#include <diffusion/Force/Force_KoecherBruchhaeuser2.tpl.hh>
...
value(
	...
	const double dt_u1{
		(t < .5) ?
		-s * 20.*M_PI / ( 10.*M_PI_2 * (4.*t-1.) * 10.*M_PI_2 * (4.*t-1.) +1. ) :
		s * 20.*M_PI / ( 10.*M_PI_2 * (4.*(t-.5)-1.) * 10.*M_PI_2 * (4.*(t-.5)-1.) +1. )
	};
...
#include "Force_KoecherBruchhaeuser2.inst.in"
