/**
 * @file Heat_cGp_dG0__cGq_cG1_DWR.tpl.cc
 * 
...
////////////////////////////////////////////////////////////////////////////////
	...
	*(dual_initial_condition) -= *(primal.storage.u->back().x); 
...
dual_assemble_Je_L2final() {
	...
	u_final->reinit(dual.iterator.slab->dual.dof->n_dofs());
	dealii::VectorTools::interpolate_to_different_mesh(
...
// // 	error_indicators->reinit(primal.iterator.slab->tria->n_active_cells());
// // 	
// // 	error_estimator.DWR->estimate(
// // 		dual.storage.u,
// // 		dual.storage.z,
...
#include "Heat_cGp_dG0__cGq_cG1_DWR.inst.in"
