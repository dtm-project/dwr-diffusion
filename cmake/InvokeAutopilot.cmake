...
################################################################################
# DEFINE custom targets to easily set and clean the .kdev_include_paths files:
...
IF("${CLEAN_UP_FILES}" STREQUAL "")
	SET(CLEAN_UP_FILES *.log *.h5 *.xdmf *.gmv *.gnuplot *.gpl *.eps *.pov *.vtk *.ucd *.d2)
ENDIF()
...
ADD_CUSTOM_TARGET(
	...
	COMMAND ${CMAKE_COMMAND} --build ${CMAKE_BINARY_DIR} --target clean-kdev_include_paths
